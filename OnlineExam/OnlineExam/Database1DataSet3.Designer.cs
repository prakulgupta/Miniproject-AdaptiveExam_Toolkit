...
namespace OnlineExam {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int Id, double marks) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public double marks {
                get {
                    try {
                        return ((double)(this[this.tableTable.marksColumn]));
                    }
...
namespace OnlineExam.Database1DataSet3TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_marks = 1 AN" +
                "D [marks] IS NULL) OR ([marks] = @Original_marks)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [marks]) VALUES (@Id, @marks);\r\nSELECT Id, marks" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [marks] = @marks WHERE (([Id] = @Original_Id" +
                ") AND ((@IsNull_marks = 1 AND [marks] IS NULL) OR ([marks] = @Original_marks)));" +
                "\r\nSELECT Id, marks FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, marks FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<double> Original_marks) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_marks.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((double)(Original_marks.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, global::System.Nullable<double> marks) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((marks.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((double)(marks.Value));
            }
            else {
        ...
        public virtual int Update(int Id, global::System.Nullable<double> marks, int Original_Id, global::System.Nullable<double> Original_marks) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((marks.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((double)(marks.Value));
            }
            else {
            ...
            if ((Original_marks.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Original_marks.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<double> marks, int Original_Id, global::System.Nullable<double> Original_marks) {
            return this.Update(Original_Id, marks, Original_Id, Original_marks);
        }
    }
